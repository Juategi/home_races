...
class _CompetitionTileState extends State<CompetitionTile> {
  ...
  List<Widget> _initImages(){
    List<Widget> list = [];
    if(competition.usersImages == null  || competition.usersImages.length == 0){
      list.add(Container(
...
class OwnerTile extends StatelessWidget {
  ...
  List<Widget> _initImages() {
            ...
            decoration: new BoxDecoration(
                ...
                image: new DecorationImage(
                    ...
                    image: new NetworkImage(
                        competition.usersImages[i] == "null" ||
                            competition.usersImages[i] == null ? CommonData
                            .defaultProfile : competition.usersImages[i])
                )
            )
        ));
      }
    ...
    list.add(SizedBox(width: 5,));
    list.add(Text(competition.numcompetitors == 1 ? "${competition
        .numcompetitors} participante" :
    "${competition.numcompetitors} participantes", style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () =>
          Navigator.pushNamed(
              context, "/editcompetition", arguments: [competition, user]),
      child: Card(
        child: Container(
          height: 135.h,
          //width: 100.w,
          child: Stack(
            children: <Widget>[
              Positioned(
                ...
                top: 5.h,
                child: Image.network(
                  competition.image, height: 125.h, width: 125.w,),
              ),
              Positioned(
                left: 160.w,
                top: 10.h,
                child: Text(competition.name.toUpperCase(), style: TextStyle(
              ...
              Positioned(
                ...
                top: 33.h,
                child: Text(
                 competition.eventdate == null? "": "${Functions.parseDate(competition.eventdate, true)}",
              ...
              Positioned(
                left: 160.w,
                top: 50.h,
                child: Text("${competition.modality} - ${competition.locality}",
              ...
              Positioned(
                ...
                top: 80.h,
                child: IconButton(
                  icon: user.favorites.contains(competition) ? Icon(
                    Icons.star, size: ScreenUtil().setSp(35),
                    color: Colors.yellow,) :
                  Icon(Icons.star_border, size: ScreenUtil().setSp(35),
