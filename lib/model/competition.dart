...
class Competition{
  ...
  List<String> gallery, usersImages;
  bool hasRace;
  Competition({this.id, this.distance, this.comments, this.enddate, this.organizer, this.numcompetitors, this.locality, this.image ,this.name, this.price, this.capacity,
    this.eventdate, this.maxdate, this.modality, this.observations, this.promoted, this.rewards, this.timezone, this.type, this.gallery, this.organizerid, this.usersImages, this.hasRace});
}